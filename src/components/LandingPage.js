    ...
    return (
        <Grid container direction="column" className={classes.mainContainer}>
            <Grid item> {/* ------ Hero Block ------ */}
                <Grid container style={{ marginBottom: matchesSM ? 0 : "10em" }} justify="flex-end" alignItems="center" direction="row">
            ...
            <Grid item> {/* ------ The Revolution Block ------ */}
                <Grid container className={classes.revolutionBackground} style={{ height: "100em", marginTop: "12em" }} alignItems="center" justify="center">
